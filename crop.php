...
class CropAvatar {
  ...
  //metodo de Renan P. Vilas
  private function purgeFile($file) {
      if (file_exists($file)) {
            unlink($file);
        }
  }  
  ...
  private function crop($src, $dst, $data) {
    if (!empty($src) && !empty($dst) && !empty($data)) {
      ...
      //purge procura a copia da imagem e exlui
      //Renan P. Vilas
      $this -> purgeFile($src);
      $componentes = explode( '.', $src );
      $truename = reset( $componentes ).'.png';
      $this -> cadastraIMG($truename);
    }
  }
